...
@section('title', "Allakro - Détail de l'emploi")
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Détails de l'offre d'emploi</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a href="index.html">Accueil</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a href="{{ route('pageEspaceRechercheEmploi') }}">
            ...
            <div class="row g-5">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <div class="bg-white shadow rounded-lg p-4 sticky-top" style="top: 30px;">
                        <h4 class="has-line-end">Guide</h4>
                        <nav id="TableOfContents">
                            <ul>
                                <li><a href="#Informatif-du-poste">Informatif du poste</a> </li>
                                <li>
                                    <a href="#Informations">Informations</a>
                                </li>
                                <li>
                                    <a href="#Critères-de-annonce-pour-le-poste">Critères de l'annonce pour le
                                        poste</a>
                                </li>

                            </ul>
                        </nav>
                        <!-- <a class="btn btn-sm btn-outline-primary mt-3" href="service-details.html">Postuler <span style="font-size: 14px;" class="las ms-2 fas fa-arrow-right"></span></a> -->
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="content">
                        <div class="row" id="Informatif-du-poste">
                            <h2>Informatif du poste</h2>
                            @if (isset($getDatas->IndividusOffreEmploi->nom_individu))
                                <b>Publié par :</b>
                                <p>
                                    {{ $getDatas->IndividusOffreEmploi->nom_individu }}&nbsp;{{ $getDatas->IndividusOffreEmploi->prenom_individu }}
                                </p>
                                <b>Profession :</b>
                                <p>{{ $getDatas->IndividusOffreEmploi->profession_individu }}</p>
                                <b>Contacts :</b>
                                <p>{{ $getDatas->IndividusOffreEmploi->telephone }}</p>
                            @else
                                <b>Publié par :</b>
                                <p>
                                    {{ $getDatas->nom_respo }}
                        ...
                        <div class="row" id="Informations">
                            <h3>Informations</h3>
                            <b>Poste proposé :</b>
                            <p style="color: red;">{{ $getDatas->service_propose }}</p>
                            <b>Responsable :</b>
                            <p>{{ $getDatas->nom_respo }}</p>
                            <b>Téléphones :</b>
                            <p> {{ $getDatas->telephone_respo }} </p>
                            <b>Adresse E-mail :</b>
                            <p> {{ $getDatas->email_respo }} </p>
                            <b>Description :</b>
                            <p> {{ $getDatas->description_offre }} </p>

                        </div>

                        <hr>
                        <div class="row" id="Critères-de-annonce-pour-le-poste">
                            <h3>Critères de l'annonce pour le poste</h3>
                            <b>Compétance :</b>
                            <p>{{ $getDatas->competance_requise }}</p>
                            @if ($getDatas->image != null)
                                <img src="{{ asset('image/' . $getDatas->image) }}" alt="Image du post"
                                    class="slick-slide slick-cloned" style="width: 50%;">
                            @endif
                        </div>
                        <!-- <a class="btn btn-sm btn-outline-primary" href="service-details.html">Postuler <span style="font-size: 14px;" class="las ms-2 fas fa-arrow-right"></span></a> -->
                    </div>
                </div>
            </div>
        </div>
