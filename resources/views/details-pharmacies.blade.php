...
@section('title', 'Allakro - Espace santé - Pharmacies')
        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Consultez vos pharmacies</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="content">
                        <p>
                            Trouvez les pharmacies disponibles dans la région d'Allakro.
                            Notre liste vous fournit les coordonnées et les horaires d'ouverture des pharmacies pour
                            vous aider à
                            accéder aux médicaments et aux soins dont vous avez besoin. <br>
                            Votre santé est importante pour nous, c'est pourquoi nous avons rassemblé ces informations
                            pour faciliter
                        ...
                        <div class="row justify-content-center">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="myTable" class="display mb-5 pt-3"
                                        style="margin-bottom: 1.5rem !important;border: none;min-width: 845px;">
                                        <thead>
                                            <tr>
                                                <th
                                                ...
                                                <th
                                                    style="width: 30rem;background-color: #DAEFFE;box-shadow: inset 0 1px 0 0 #C1E4FE,inset 0 -1px 0 0 #C1E4FE;text-align: center;height: 18px;color: #162D3D;font-size: 16px;border: none !important;font-weight: 600;padding:0.6rem 0.6rem !important;padding-inline-end: 12px;">
                                                    Contacts & Localisation géographique
                                                </th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody style="border: none;">
                                            @foreach ($getInfo as $val)
                                                <tr
                                                    style="background: #fff;box-shadow: none;border: none;color: var(--bs-gray);">
                                                    <td style="background: #fff;box-shadow: none;">
                                                        {{ $val->nom_pharmacie }}
                                                    </td>
                                                    <td style="background: #fff;box-shadow: none;">
                                                        @if ($val->de_garde == false)
                                                            <span class="badge bg-label-danger me-1"
                                                                style="line-height: 1.75;background-color: #ffe0db !important;color: #ff3e1d !important;">
                                                                Ouvert de 8h30 à 20h (Lundi - Vendredi)
                                                            </span>
                                                        @else
                                                            <span style="background: #fff;box-shadow: none;padding:0;">
                                                                ...
                                                                <i class="d-block text-center">
                                                                    <small>
                                                                        Du<b>
                                                                            {{ \Carbon\Carbon::parse($val->date_debut)->format('d-m-Y') }}</b>
                                                                        au
                                                                        <b>{{ \Carbon\Carbon::parse($val->date_fin)->format('d-m-Y') }}
                                                                        </b>
                                                                    </small>
                                                                </i>
                                                            </span>
                                                    ...
                                                    <td style="background: #fff;box-shadow: none;">
                                                        <b>Tel</b>: {{ $val->telephone_pharmacie }} | <b>Email</b>:
                                                        {{ $val->email_pharmacie }}<br>
                                                        <b>Localisation</b>: {{ $val->emplacement }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
