...
@section('title', 'Allakro - Espace santé - Centre de Santé')
        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Centres de santé</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="content">
                        <p>
                            Découvrez les centres de santé situés dans la région d'Allakro, dans le voisinage ou dans un
                            rayon de 2 Kilomètres. Ces centres offrent une
                            gamme de services médicaux, des consultations aux soins spécialisés. <br>
                            Nous voulons nous assurer que chaque habitant d'Allakro ait accès à des soins de qualité. C'est
                            pourquoi nous mettons à
                            jour régulièrement cette liste de centres de santé pour vous offrir les meilleures options de
                            santé possibles.
                        </p>
                        <hr>
                                        ...
                                        <tbody style="border: none;">
                                            @foreach($getInfo as $val)
                                                <tr
                                                    ...
                                                    <td style="background: #fff;box-shadow: none;border: none;">
                                                        {{ $val->emplacement_centre }}
                                                    </td>
                                                    <td style="background: #fff;box-shadow: none;border: none;">
                                                        Tel : <b>{{ $val->telephone_centre }}</b> <br>
                                                        E-mail : <b>{{ $val->email_centre }}</b> <br>
                                                        Soins : {{ $val->offre_centre }}
                                                    </td>
                                                </tr>
                                            @endforeach
