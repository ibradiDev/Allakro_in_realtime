...
@section('title', 'Allakro - Nos contacts')
        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Adresse & coordonnées d'Allakro</h2>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">Contactez l'administration</p>
                        <h1>Contactez nous</h1>
                        <p>Contactez dès maintenant l'administration via ce formulaire ou nos coordonnées de contact pour
                            tout autres préocupations.</p>
                    </div>
                </div>
                <div class="col-lg-10">
                                ...
                                <div class="contact-form">
                                    <form method="POST" action="{{ route('messagerie.store') }}">
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            <label for="sender" class="form-label">Nom complet</label>
                                            <input type="text" name="sender" placeholder="Par exemple : ALLA ELYSEE"
                                                class="form-control shadow-none" id="sender">
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="sender_email" class="form-label">Adresse E-mail</label>
                                            <input type="email" name="sender_email"
                                                placeholder="Par exemple : elyalla@gmail.com"
                                                class="form-control shadow-none" id="sender_email">
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="message" class="form-label">Message</label>
                                            <textarea name="message" class="form-control shadow-none" placeholder="En quoi pouvons nous vous aider?"
                                                id="message"></textarea>
                                        </div>

                                        <button class="btn btn-primary w-100" type="submit">Envoyer le message</button>
                                    </form>
                                </div>
                            </div>
                            <div class="col-lg-6 mt-5 mt-lg-0">
                                <div class="contact-info">
                                    <div class="block mt-0">
                                        <h4 class="h5">Des questions ?</h4>
                                        <div class="content">Appelez-nous, nous serons heureux de vous aider
                                            <br> <a class="" href="tel:+2250556368816">+2250556368816</a>
                                            <br>Lundi - Vendredi
                                            <br>Disponible de 13H A 13H30
                                        </div>
                                    </div>
                                    <div class="block mt-4">
                                        <h4 class="h5">Adresses</h4>
                                        <div class="content">Abidjan, Yopougon.
                                            <br>sanlegrace2003@gmail.com,
                                        </div>
                                        <div class="block">
