@extends('layouts.app')
@section('title', "Détails - maladies & épidemies")
@section('content')
    <section class="page-header">
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Maladies et Epidémies</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a href="{{ route('pageAccueil') }}">Accueil</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a href="{{ route('pageAccueilSante') }}">Espace Santé</a>
                        </li>
    ...
    <section class="section-sm bg-tertiary">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="content">
                        <p>
                            Découvrez les informations concernant les épidémies et maladies qui peuvent affecter la région
                            d'Allakro.
                            Nous mettons à votre disposition les dernières données et mises à jour sur les épidémies en
                            cours, les mesures préventives à
                            prendre et les ressources disponibles pour vous aider à vous protéger et à protéger votre
                            communauté. <br>
                            Restez informé(e) sur les maladies émergentes et les épidémies qui pourraient impacter la
                            région.
                        </p>
                        <hr>
                        <div class="row">
                            <div class="col-lg-12">
                                <ul class="payment_info_tab nav nav-pills justify-content-center mb-4" id="pills-tab" role="tablist">
                                    <li class="nav-item m-2" role="presentation"> <a
                                            ...
                                            aria-controls="pills-how-much-can-i-recive" aria-selected="true" >Epidémies</a>
                                    </li>
                                    <li class="nav-item m-2" role="presentation"> <a
                                            ...
                                            aria-controls="pills-how-much-does-it-costs" aria-selected="true" >Maladies</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="pills-how-much-can-i-recive" role="tabpanel"
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12 order-1 order-md-0">
                                                @foreach($getDatasEp as $ep)
                                                    <div class="content-block mb-3" style="border-bottom: 1px solid var(--bs-light);background-color: #66a0d50d;padding: 1px 11px;border-radius: 10px;">
                                                        <h3 class="mb-4">{{ $ep->nom_epidemie }} 
                                                            @if($ep->is_active === 1)
                                                                <span class="badge bg-success" style="font-size: 11px;float: inline-end;">Epidémie en activité</span>
                                                            @else
                                                                <span class="badge bg-primary" style="font-size: 11px;float: inline-end;">Epidémie passée</span>
                                                            @endif
                                                        </h3>
                                                        <div class="content">
                                                            <p>
                                                                <b>Mesures à prendre :</b>
                                                                {{ $ep->mesure_preventive }}
                                                            ...
                                                            <p>
                                                                <b>Nombre de cas :</b>
                                                                {{ $ep->nombre_de_cas_epidemie }} | 
                                                                <b>Nombre de victime :</b>
                                                                {{ $ep->nombre_de_deces_epidemie }}
                                                            </p>
                                                            <p>
                                                                <b>Zones concernées :</b>
                                                                {{ $ep->zone_concernee }}
                                                            </p>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12 order-1 order-md-0">
                                                <div class="content-block">
                                                    @foreach($getDatasMa as $ma)
                                                        <div class="content-block mb-3" style="border-bottom: 1px solid var(--bs-light);background-color: #FBFBFB;padding: 1px 11px;border-radius: 10px;">
                                                            <h3 class="mb-4">{{ $ma->nom_maladie }} 
                                                                @if($ma->is_active === 1)
                                                                    <span class="badge bg-success" style="font-size: 11px;float: inline-end;">Toujours en actualité</span>
                                                                @else
                                                                    <span class="badge bg-primary" style="font-size: 11px;float: inline-end;">Maladie passée</span>
                                                                @endif
                                                            </h3>
                                                            <div class="content">
                                                                <p>
                                                                    <b>Description :</b>
                                                                    {{ $ma->description_maladie }}
                                                                    
                                                                </p>
                                                                <p>
                                                                    <br>
                                                                    <b>Voie de transmission :</b>
                                                                    {{ $ma->mode_transmission_maladie }}
                                                                </p>
                                                                
                                                                <p>
                                                                    <b>Caracteristiques :</b>
                                                                    {{ $ma->caracteristique_maladie }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    @endforeach
