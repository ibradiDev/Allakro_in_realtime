...
@section('title', 'Allakro - Notre communauté')
    ...
    <div class="container">
        <div class="row">
            <div class="col-8 mx-auto text-center">
                <h2 class="mb-3 text-capitalize">Tout sur notre communauté</h2>
                <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                    <li class="list-inline-item">
                        <a href="{{ route('pageAccueil') }}">Accueil</a>
                    </li>
                    <li class="list-inline-item">/ &nbsp;
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6">
                <div class="section-title">
                    <p class="text-primary text-uppercase fw-bold mb-3">Description d'Allakro</p>
                    <h2 class="h1 mb-4">Allakro <br> Notre communauté</h2>
                    <div class="content pe-0 pe-lg-5">
                        ...
                        <p>
                            On y trouve des Ivoiriens, des Burkinabés,
            ...
            <div class="col-lg-6 mt-5 mt-lg-0">
                <img loading="lazy" decoding="async" src="{{ asset('font_utilisateurs/images/banner/photo_1653954174.jpeg') }}" alt="Image communauté à Allakro" class="rounded w-100" width="100">
            </div>
        </div>
    </div>
</section>

<section class="section pb-5" id="projet-de-la-mairie">
    <div class="container">
        <div class="row justify-content-center align-items-center mb-4">
            <div class="col-lg-6">
                <div class="section-title text-center">
                    <p class="text-primary text-uppercase fw-bold mb-3">Nos Ambitions</p>
                    <h1>Projets de la mairie</h1>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-9">
                <div class="accordion accordion-border-bottom" id="additional_Info">
                    ...
                    <div class="accordion-item bg-transparent">
                        <h2 class="accordion-header accordion-button h5 border-0" id="heading-8a4ed081f8ec73b6e9377f609cffed128b925ed9-{{ $value->id }}" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-8a4ed081f8ec73b6e9377f609cffed128b925ed9-{{ $value->id }}" aria-expanded="true" aria-controls="collapse-8a4ed081f8ec73b6e9377f609cffed128b925ed9-{{ $value->id }}">
                            {{ $value->titre }}
                        </h2>
                        <div id="collapse-8a4ed081f8ec73b6e9377f609cffed128b925ed9-{{ $value->id }}" class="accordion-collapse collapse border-0" aria-labelledby="heading-8a4ed081f8ec73b6e9377f609cffed128b925ed9-{{ $value->id }}" data-bs-parent="#additional_Info">
                            <div class="accordion-body py-0 content">
                                <h6 id="service-provided-as-is">
                                    Date fixé pour les travaux :
                                    <span class="text-danger">{{ $value->debut_projet }} ---
                                        {{ $value->fin_projet }}</span>
                                </h6>
...
<section class="py-0 about-sectio bg-tertiaryn section position-relative overflow-hidden">
    @if (session('Success'))
    ...
    <div class="container">
        <div class="row">
            <p class="text-primary text-uppercase text-center fw-bold mb-5">Fils d'actualité</p>
            <div class="col-lg-9">
                <div class="me-lg-4">
                    <div class="row gy-5">
                        @foreach ($getInfoActu as $actu)
                        <div class="col-md-6" data-aos="fade">
                            <article class="blog-post">
                                <div class="post-slider slider-sm rounded slick-initialized slick-slider">
                                    <div class="slick-list draggable">
                                        <div class="slick-track" style="opacity: 1; width: 392px; transform: translate3d(0px, 0px, 0px);">
                                            <img loading="lazy" decoding="async" src="{{ asset('font_utilisateurs/images/blog/post-1.jpg') }}" alt="Poste actualité" class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 392px;" tabindex="0">
                                        </div>
                                    </div>
                                </div>
                                <div class="pt-4">
                                    <p class="mb-3">Publié le : {{ $actu->created_at->format('d/m/Y') }}</p>
                                    <h2 class="h4">
                                        <a class="text-black" href="{{ route('pageDetailsPostActualite', $actu->id) }}">
                                            {{ $actu->titre_actualite }}
                                        </a>
                                    </h2>
                                    <p>
                                        {{ \App\Http\Middleware\Helpers\Text::excerpt($actu->contenu) }}
                                    </p>
                                    <a href="{{ route('pageDetailsPostActualite', $actu->id) }}" class="text-primary fw-bold" aria-label="Read the full article by clicking here">Lire la suite
                                    </a>
                                </div>
                            </article>
                        </div>
                        ...
                        <div class="col-12">
                            <nav class="mt-4">
                                <!-- pagination -->
                                <nav class="mb-md-50 justify-content-center d-flex">
                                    {{ $getInfoActu->links() }}
                                </nav>
                            </nav>
                        </div>
            ...
            <div class="col-lg-3">
                <!-- latest post -->
                <div class="widget">
                    <h5 class="widget-title"><span>Publications anciens</span></h5>
                    <!-- post-item -->
                    <ul class="list-unstyled widget-list">
                        @foreach ($getInfoActuRecent as $value)
                        <li class="d-flex widget-post align-items-center mb-2">
                            <a class="text-black" href="{{ route('pageDetailsPostActualite', $value->id) }}">
                                <div class="widget-post-image flex-shrink-0 me-3">
                                    <img class="rounded" loading="lazy" decoding="async" src="{{ asset('font_utilisateurs/images/blog/post-1.jpg') }}" alt="Post Thumbnail">
                                </div>
                            </a>
                            <div class="flex-grow-1">
                                <h5 class="h6 mb-0"><a class="text-black" href="{{ route('pageDetailsPostActualite', $value->id) }}">
                                        {{ $value->titre_actualite }}</a></h5>
                                <small>Publié le : {{ $value->created_at->format('d/m/Y') }}</small>
                            </div>
                        </li>
                        @endforeach
                ...
                <!-- Social -->
                <div class="widget">
                    <h4 class="widget-title"><span>Suivez nous sur</span></h4>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Récupérer l'élément cible par son ID
        var element = document.getElementById('projet-de-la-mairie');

        // Vérifier si l'élément existe avant de faire le défilement
        if (element) {
