            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-lg-6 mt-5 mt-lg-0">
                    <img loading="lazy" decoding="async"
                        src="{{ asset('font_utilisateurs/images/banner/photo_1653954174.jpeg') }}"
                        alt="Image communauté à Allakro" class="rounded w-100" width="100">
                </div>
            </div>
        </div>
    </section>
                        ...
                        @foreach ($getInfo as $value)
                            <div class="accordion-item bg-transparent">
                                <h2 class="accordion-header accordion-button h5 border-0"
                                    id="heading-8a4ed081f8ec73b6e9377f609cffed128b925ed9-{{ $value->id }}" type="button"
                                    data-bs-toggle="collapse"
                                    data-bs-target="#collapse-8a4ed081f8ec73b6e9377f609cffed128b925ed9-{{ $value->id }}"
                                    aria-expanded="true"
                                    aria-controls="collapse-8a4ed081f8ec73b6e9377f609cffed128b925ed9-{{ $value->id }}">
                                    {{ $value->titre }}
                                </h2>
                                <div id="collapse-8a4ed081f8ec73b6e9377f609cffed128b925ed9-{{ $value->id }}"
                                    class="accordion-collapse collapse border-0"
                                    aria-labelledby="heading-8a4ed081f8ec73b6e9377f609cffed128b925ed9-{{ $value->id }}"
                                    ...
                                    <div class="accordion-body py-0 content">
                                        <h6 id="service-provided-as-is">
                                            ...
                                            <span class="text-danger">
                                                {{ Carbon\Carbon::createFromDate($value->debut_projet)->format('d-m-Y') }}
                                                <span class="text-black">====></span>
                                                {{ Carbon\Carbon::createFromDate($value->fin_projet)->format('d-m-Y') }}</span>
                                        </h6>
                                ...
                                <div class="col-md-6" data-aos="fade">
                                    <article class="blog-post">
                                        <div class="post-slider slider-sm rounded slick-initialized slick-slider">
                                            <div class="slick-list draggable">
                                                <div class="slick-track"
                                                    style="opacity: 1; width: 392px; transform: translate3d(0px, 0px, 0px);">
                                                    <img loading="lazy" decoding="async"
                                                        src="{{ asset('font_utilisateurs/images/blog/post-1.jpg') }}"
                                                        alt="Poste actualité"
                                                        class="slick-slide slick-current slick-active"
                                                        data-slick-index="0" aria-hidden="false" style="width: 392px;"
                                                        tabindex="0">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pt-4">
                                            ...
                                            <h2 class="h4">
                                                <a class="text-black"
                                                    href="{{ route('pageDetailsPostActualite', $actu->id) }}">
                                            ...
                                            <a href="{{ route('pageDetailsPostActualite', $actu->id) }}"
                                                class="text-primary fw-bold"
                                                aria-label="Read the full article by clicking here">Lire la suite
                                            </a>
                                        </div>
                                    </article>
                                </div>
                                ...
                                <li class="d-flex widget-post align-items-center mb-2">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="h6 mb-0"><a class="text-black"
                                                href="{{ route('pageDetailsPostActualite', $value->id) }}">
