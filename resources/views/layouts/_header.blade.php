               ...
               <div class="col-lg-6 mb-4 pb-2">
                  <div class="form-group">
                     ...
                     <input name="nom_individu" placeholder="Entrez votre nom de famille" type="text"
                        class="form-control shadow-none @error('nom_individu') is-invalid @enderror" id="nom_individu"
               ...
               <div class="col-lg-6 mb-4 pb-2">
                  <div class="form-group">
                     ...
                     <select name="sexe_individu"
                        class="form-control shadow-none @error('sexe_individu') is-invalid @enderror" id="sexe_individu"
                        required>
                        <option></option>
               ...
               <div class="col-lg-6 mb-4 pb-2">
                  <div class="form-group">
                     ...
                     <input name="telephone" placeholder="Entrez votre numéro de telephone" type="tel"
                        class="form-control shadow-none @error('telephone') is-invalid @enderror" id="telephone"
