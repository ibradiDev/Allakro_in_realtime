      ...
      <div class="layout-wrapper layout-content-navbar">
         <div class="layout-container">
            ...
            <div class="layout-page">
               <!-- Navbar -->
               <nav
                  class="position-sticky sticky-top bg-light text-dark layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                  id="layout-navbar">
                  ...
                  <div class="container-xxl flex-grow-1 container-p-y">
                     ...
                     $(document).ready(function() {
                        $('#confirmModal').on('show.bs.modal', function(event) {
                           var button = $(event
                              .relatedTarget); // Bouton qui a déclenché l'ouverture du modal
                           console.log("Cest le button ", button);
                           var formType = button.data(
                              'form-type'); // Type de formulaire (naissance ou décès)
