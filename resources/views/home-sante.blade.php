...
@section('title', 'Allakro - Espace santé')
        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Tout pour votre bien-être</h2>
            ...
            <div class="row justify-content-center">
                <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                    <div class="rounded shadow py-5 px-4">
                        <div class="icon"> <i class="fas fa-virus"></i>
                        </div>
                        <h3 class="mb-3">Maladies & Epidémies</h3>
                        <p class="mb-4">Restez informé(e) sur les maladies émergentes et les épidémies qui pourraient
                            impacter la région</p>
                        <a class="btn btn-sm btn-outline-primary" href="{{ route('pageConsultationMldEpd') }}">
                            En savoir plus <i class="las la-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
                <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                    <div class="rounded shadow py-5 px-4">
                        ...
                        <h3 class="mb-3">Centres de santé</h3>
                        <p class="mb-4">Trouvez le centre de santé adapté à vos besoins et prenez soin de votre santé en
                            toute sérénité.</p>
                        <a class="btn btn-sm btn-outline-primary" href="{{ route('pageConsulatationCtrSantes') }}">
                            Trouver un centre <i class="las la-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
                <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                    <div class="rounded shadow py-5 px-4">
                        <div class="icon"> <i class="fas fa-pills"></i>
                        </div>
                        <h3 class="mb-3">Nos pharmacies</h3>
                        <p class="mb-4">N'hésitez pas à consulter cette liste pour trouver la pharmacie la plus proche de
                            chez vous.</p>
                        <a class="btn btn-sm btn-outline-primary" href="{{ route('pageConsulatationPharmacie') }}">
                            Trouver une pharmacie <i class="las la-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
            </div>
