...
@section('title', 'Accueil - Espace famille Allakro')
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Espace Familles</h2>
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto mb-4">
                    <div class="section-title">
                        <p class="text-primary text-uppercase fw-bold mb-3">Portail familiale d'Allakro</p>
                        <h2>🎉 Enregistrement des naissances ! 🎉</h2>
                    </div>
                    <p class="lead" style="font-size: 18px;">
                        Nous sommes ravis de vous accompagner dans cette étape importante de votre vie.
                        Enregistrer la naissance d'un nouveau-né est une démarche essentielle,
                        car cela permet de lui ouvrir les portes d'un avenir rempli d'opportunités. <br>
                        L'enregistrement des naissances est un droit fondamental et une responsabilité civique.
                        C'est aussi une manière de contribuer à la construction d'une société plus juste et équitable. <br>
                        Pour commencer le processus, veuillez cliquer sur le bouton "<b
                            style="font-weight: 700;">J'enregistre une naissance</b>" ci-dessous.
                        Remplissez ensuite le formulaire avec les informations nécessaires, et nous traiterons votre demande
                        dans les meilleurs délais.
                    </p>
                    <a href="{{ route('pageFormulaireNaissances', ['member' => Auth::user()]) }}"
                        class="btn btn-primary d-block mt-3" style="width: fit-content;" {{-- href="{{ route('pageListeDeces') }}" --}}
                        data-form-type="naissance">
                        Déclarer une naissance <span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span>
                    </a>
                </div>
                ...
                <div class="col-lg-10 mx-auto">
                    <div class="section-title">
                        ...
                        <h2>🕊️ Déclaration de décès 🕊️</h2>
                    </div>
                    <p class="lead" style="font-size: 18px;">
                        La déclaration des décès est une étape légale essentielle, qui permet d'établir officiellement le
                        décès d'une
                        personne et d'obtenir les documents nécessaires pour les formalités administratives. <br>
                        Notre équipe est composée de professionnels bienveillants et compréhensifs, prêts à vous guider à
                        travers toutes les étapes de cette procédure.
                        Nous nous engageons à traiter votre demande avec la plus grande discrétion et à vous offrir un
                        service de qualité. <br>
                        Pour commencer la déclaration du décès, veuillez cliquer sur le bouton "
                        <b style="font-weight: 700;">Déclarer un décès</b>" ci-dessous.
                        Remplissez ensuite le formulaire avec les informations nécessaires, et nous prendrons en charge
                        votre demande dans les meilleurs délais.

                    </p>
                    <a href="{{ route('pageFormulairedecess', ['member' => Auth::user()]) }}"
                        class="btn btn-primary d-block mt-3" style="width: fit-content;" {{-- href="{{ route('pageListeDeces') }}" --}}
                        data-form-type="deces">
                        Déclarer un décès <span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span>
                    </a>
