...
@section('title', 'Accueil - Espace déplacement Allakro')
...
@section('content')
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('reqInformationSaved2') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-4 pb-2">
                                    <div class="form-group">
                                        <label for="nom_famille" class="form-label">Nom de famille <span
                                                class="text-danger">*</span></label>
                                        <input name="nom_famille" placeholder="Entrez votre nom de famille" type="text"
                                            class="form-control shadow-none" id="nom_famille"
                                ...
                                <div class="col-lg-6 mb-4 pb-2">
                                    <div class="form-group">
                                        <label for="prenom" class="form-label">Prenom <span
                                                class="text-danger">*</span></label>
                                        <input name="prenom" placeholder="Entrez votre prenom" type="text"
                                            class="form-control shadow-none" id="prenom" value="{{ old('prenom') }}"
                                            required>
                                        <div class="invalid-feedback">
                                            @error('prenom')
                                                {{ $message }}
                                ...
                                <div class="col-lg-12 mb-4 pb-2">
                                    <div class="form-group">
                                        <label for="telephone" class="form-label">Numéro de téléphone <span
                                                class="text-danger">*</span></label>
                                        <input name="telephone" placeholder="Entrez votre numéro de telephone" type="text"
                                            class="form-control shadow-none" id="telephone" value="{{ old('telephone') }}"
                                            required>
                                        <div class="invalid-feedback">
                                            @error('telephone')
                                                {{ $message }}
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Espace Déplacements</h2>
    ...
    <section class="about-section bg-tertiary section position-relative overflow-hidden">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto mb-4">
                    <div class="section-title">
                        <p class="text-primary text-uppercase fw-bold mb-3">Portail déplacements d'Allakro</p>
                        <h2>🏠 Aménagement dans le village 🏠</h2>
                    </div>
                    <p class="lead" style="font-size: 18px;">
                        Si vous avez récemment emménagé dans notre village, nous sommes ravis de vous accueillir parmi nous ! 
                        Nous vous invitons à remplir le formulaire d'enregistrement afin que nous puissions 
                        mieux vous connaître et vous souhaiter la bienvenue comme il se doit.<br>
    
                        Pour commencer le processus, veuillez cliquer sur le bouton "<b style="font-weight: 700;">Enregistrer l'aménagement</b>" ci-dessous. 
                        Remplissez ensuite le formulaire avec les informations nécessaires, et nous traiterons votre demande dans les meilleurs délais.
                    </p>
                    <a type="button" class="btn btn-primary d-block mt-3" style="width: fit-content;" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#authModal" data-form-type="amenagement">
                        Enregistrer l'aménagement <span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span>
                    </a>
                </div>
                <div class="col-lg-10 mx-auto">
                    ...
                    <p class="lead" style="font-size: 18px;">
                        Si vous prévoyez de déménager du village d'Allakro, nous vous remercions de bien vouloir nous en informer en remplissant le 
                        formulaire d'enregistrement ci-dessous. Votre déménagement est important pour nous, 
                        car cela nous permettra de tenir à jour nos registres et de mieux comprendre les mouvements de population dans notre communauté. <br>
                        Pour commencer, veuillez cliquer sur le bouton "<b style="font-weight: 700;">Enregistrer le déménagement</b>" ci-dessous. 
                        Remplissez ensuite le formulaire avec les informations nécessaires, et nous prendrons en charge votre demande dans les meilleurs délais.
                    </p>
                    <a type="button" class="btn btn-primary d-block mt-3" style="width: fit-content;" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#authModal" data-form-type="demenagement">
                        Enregistrer le déménagement <span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span>
                    </a>
